            ...
            <div class="col-xl-12">
                <div class="relative_contect d-flex">
                    ...
                    <ul class="wsus_menu_cat_item show_home toggle_menu">
                            ...
                            <li><a class="wsus__droap_arrow" href="#"><i class="{{$category->icon}}"></i> {{ $category->name }} </a>
                                <ul class="wsus_menu_cat_droapdown">
                                    @foreach($category->subCategories->take(5) as $subCategory)
                                        <li><a href="#"> {{ $subCategory->name }} <i class="@if($subCategory->childCategories->count() > 0) fas fa-angle-right @endif"></i></a>
                        ...
                        <li><a href="#"><i class="fal fa-gem"></i> Просмотреть все категории</a></li>
                    </ul>
