                ...
                <div class="col-xl-2 col-7 col-md-8 col-lg-2">
                    <div class="wsus_logo_area">
                        <a class="wsus__header_logo" href="{{route('home')}}">
                            <img src="{{asset('frontend/images/alexse/White_ru-min.png')}}" alt="logo" class="w-full">
                        </a>
                    </div>
                </div>
                ...
                <div class="col-xl-6 col-3 col-md-3 col-lg-6">
                    <div class="wsus__call_icon_area">
                        <div class="wsus__call_area">
                            ...
                            <div class="">
                                <strong><a href="tel:+37360001103" class="text-white">+37360001103 <span class="text-white">Торговое оборудование</span></a></strong>
                                <strong><a href="tel:+37369900989" class="text-white border-top">+37369900989 <span class="text-white">Промышленое оборудование</span></a></strong>
                            </div>
                        </div>
