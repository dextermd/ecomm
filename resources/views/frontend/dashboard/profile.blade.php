                            ...
                            <div class="wsus__dash_pro_area">
                                ...
                                <form method="POST" action="{{route('user.profile.update')}}" enctype="multipart/form-data">
                                    ...
                                    <div class="col-md-12">
                                        <div class="col-md-2">
                                            <div class="wsus__dash_pro_img">
                                                <img src="{{Auth::user()->image ? asset(Auth::user()->image) : asset('frontend/images/default-avatar.jpg')}}" alt="img" class="img-fluid w-100">
                                        ...
                                        <div class="col-md-12 mt-5">
                                            <div class="wsus__dash_pro_single">
                                                ...
                                                <input id="name" type="text" placeholder="Name" name="name" value="{{Auth::user()->name}}">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-12">
                                            <div class="wsus__dash_pro_single">
                                                ...
                                                <input id="email" type="email" placeholder="Email" name="email"  value="{{Auth::user()->email}}">
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-xl-12">
                                        ...
                                        <div class="wsus__dash_pass_change py-3">
                                            <form action="{{route('user.profile.update.password')}}" method="POST">
                                                @csrf
                                                <div class="row">
                                                    <h4 class="pt-3">Update Password</h4>
